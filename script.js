...
if (localStorage.getItem('mode') === 'დღის რეჟიმი') {
  // add "dark" class to body and set modeSwitch text to "Light Mode"
  body.classList.add('dark')
  modeSwitch.textContent = 'დღის რეჟიმი'
}
...
modeSwitch.addEventListener('click', () => {
  ...
  modeSwitch.textContent = isDarkMode ? 'დღის რეჟიმი' : 'ღამის რეჟიმი'
  // set localStorage "mode" item based on "dark" class presence
  localStorage.setItem('mode', isDarkMode ? 'დღის რეჟიმი' : 'ღამის რეჟიმი')
})
